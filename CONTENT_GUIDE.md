...
Практика руками: то, после чего на собеседовании можно сказать «я делал», а не
«я читал». Минимум 3 шага и 3 пункта чек-листа.

**У проекта намеренно НЕТ собственного состояния.** Сделанным он считается
тогда, когда человек описал доказательство у требования вакансии, на которое
проект ссылается через `requirement_id`. Вторая отметка «выполнено» рядом с
доказательством была бы вторым источником правды об одном факте — и они
разъехались бы при слиянии с другого устройства. Поэтому `requirement_id`
обязан существовать в вакансии трека: иначе проект нечем закрыть, а
ограничитель готовности останется включённым навсегда.
