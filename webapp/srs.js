...
(function (global) {
  ...
  //
  // У слова ДВА независимых префикса, по одному на направление. Узнавание
  // (ew: вижу «queue» — вспоминаю значение) даётся заметно раньше, чем
  // производство (ewr: знаю смысл — достаю английское слово), и это разные
  // навыки: на собеседовании нужен второй. Общая коробка на оба направления
  // засчитывала бы лёгкую сторону за трудную и возвращала слово на повтор не
  // тогда, когда оно забывается.
  var TYPES = { question: "q", term: "t", mock: "m", "case": "c",
    eword: "ew", ewordRev: "ewr", edrill: "ed", ephrase: "eph" };
